...
import com.farrell.muslimpedia.databinding.FragmentAboutAlQuranBinding
...
class AboutAlQuranFragment : Fragment() {
    lateinit var binding : FragmentAboutAlQuranBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (commonViewModel.aboutAlQuranNews.value == null){
            commonViewModel.getAboutAlQuranNews()
        }

        commonViewModel.getAboutAlQuranNews()
        commonViewModel.aboutAlQuranNews.observe(viewLifecycleOwner){ dataNews ->
